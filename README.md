# ConCoin
A cryptocurrency with provable and unbiased randomness. This repo provides the security. The [client](https://github.com/CPoof/ConCoin-Client) aims to format input.\
